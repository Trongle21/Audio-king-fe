...
export const metadata: Metadata = genMetadata({
  title: "Thanh toán",
  description:
    "Hoàn tất đơn hàng tại HVN AUDIO với biểu mẫu thông tin giao hàng và thanh toán an toàn, nhanh chóng.",
  canonical: "/checkout",
})
    ...
    <main className="container py-6 md:py-8 lg:py-10">
      ...
      <header className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Vui lòng điền thông tin chính xác để HVN AUDIO giao hàng nhanh hơn.
        </p>
      </header>
