    ...
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <select
          id="categoryId"
          name="categoryId"
          className="w-3/4 h-10 xl:w-full rounded-md border bg-background px-2 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
