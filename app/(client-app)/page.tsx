  ...
  return (
    <>
      ...
      <div className="space-y-10 pb-10">
          ...
          <div className="container space-y-4">
            <header className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground md:text-base">
                Những sản phẩm audio được khách hàng lựa chọn nhiều nhất trong
                thời gian gần đây.
              </p>
            </header>
        ...
        <section aria-labelledby="hall-heading" className="bg-muted/40 py-6">
          <div className="container space-y-4">
            <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground md:text-base">
                  Giải pháp trọn bộ cho hội trường, sân khấu, đám cưới, sự kiện.
                </p>
              </div>
        ...
        <section aria-labelledby="karaoke-heading" className="bg-background">
          <div className="container space-y-4">
            <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                <h2
                ...
                <p className="text-sm text-muted-foreground md:text-base">
                  Tuyển chọn các mẫu loa karaoke bán chạy, được đánh giá cao về
